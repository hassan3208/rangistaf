...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg transition-transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-green-500"
    >
      <svg
      ...
      >
        <path
          fill="#20A83E"
          d="M437.019,74.98C388.668,26.628,324.38,0,256,0S123.333,26.628,74.98,74.98S0,187.62,0,256
        ...
        />
        <circle fill="#E5E5E5" cx="256" cy="256" r="213.333" />
        <circle fill="#FFFFFF" cx="256" cy="256" r="187.733" />
        <path
          fill="#20A83E"
          d="M392.391,342.641l-7.673-41.561c-0.635-3.432-3.295-6.133-6.718-6.818l-60.339-12.067
        ...
        <path
          fill="#189433"
          d="M349.996,376.428c-4.747,0-9.698-0.401-14.838-1.21c-40.801-6.419-97.583-26.41-134.583-63.265
